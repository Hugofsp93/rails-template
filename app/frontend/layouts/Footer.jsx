export default function Footer() {
  return (
    <footer className="bg-white shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-neutral-950 antialiased">
      ...
      <div className="flex justify-center items-center space-x-1">
        ...
        <div id="tooltip-dribbble" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-neutral-700 bg-white dark:text-white dark:bg-neutral-700 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip">
          Check out my Steam profile
          <div className="tooltip-arrow" data-popper-arrow></div>
        </div>
        <a href="https://x.com/hgfllp" data-tooltip-target="tooltip-twitter" className="inline-flex justify-center p-2 text-neutral-500 rounded-lg cursor-pointer dark:text-neutral-400 dark:hover:text-white hover:text-neutral-900 hover:bg-neutral-100 dark:hover:bg-neutral-600" target="_blank" rel="noopener noreferrer">
        ...
        <div id="tooltip-twitter" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-neutral-700 bg-white dark:text-white dark:bg-neutral-700 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip">
        ...
        <div id="tooltip-github" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-neutral-700 bg-white dark:text-white dark:bg-neutral-700 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip">
          Star us on GitHub
          <div className="tooltip-arrow" data-popper-arrow></div>
        </div>
        ...
        <div id="tooltip-facebook" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-neutral-700 bg-white dark:text-white dark:bg-neutral-700 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip">
