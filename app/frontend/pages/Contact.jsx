  ...
  return (
    <section>
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-neutral-900 dark:text-white">Contact Us</h2>
        ...
        <form action="#" className="space-y-8">
          ...
          <div className="sm:col-span-2">
            ...
            <textarea id="message" rows="6" className="block p-2.5 w-full text-sm text-neutral-900 bg-neutral-50 rounded-lg shadow-sm border border-neutral-300 focus:ring-neutral-500 focus:border-neutral-500 dark:bg-neutral-700 dark:border-neutral-700 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-neutral-500 dark:focus:border-utility-500" placeholder="Leave a comment..."></textarea>
          </div>
          <button type="submit" className="text-white bg-utility-700 hover:bg-utility-800 focus:ring-2 focus:outline-none focus:ring-utility-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-utility-500 dark:hover:bg-utility-600 dark:focus:ring-utility-800">Send message</button>
        </form>
      </div>
    </section>
  )
