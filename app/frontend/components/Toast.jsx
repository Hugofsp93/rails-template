...
export default function Toast({ message, type = 'success', duration = 5000 }) {
  useEffect(() => {
    ...
    toast.className = `fixed top-20 right-4 z-10 flex items-center w-full max-w-xs p-4 mb-4 text-zinc-500 bg-white rounded-lg shadow dark:text-zinc-400 dark:bg-zinc-900 animate-enter`
    toast.role = 'alert'
    ...
    toast.innerHTML = `
      ...
      <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-white text-zinc-400 hover:text-zinc-900 rounded-lg focus:ring-2 focus:ring-zinc-300 p-1.5 hover:bg-zinc-100 inline-flex items-center justify-center h-8 w-8 dark:text-zinc-500 dark:hover:text-white dark:bg-zinc-900 dark:hover:bg-zinc-700">
