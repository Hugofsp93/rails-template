...
export default function Toast({ message, type = 'success', duration = 5000 }) {
  useEffect(() => {
    ...
    toast.className = `fixed top-20 right-4 z-10 flex items-center w-full max-w-xs p-4 mb-4 text-neutral-500 bg-neutral-50 rounded-lg shadow dark:text-neutral-400 dark:bg-neutral-900 animate-enter`
    toast.role = 'alert'
    ...
    toast.innerHTML = `
      ...
      <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-neutral-50 text-neutral-400 hover:text-neutral-900 rounded-lg focus:ring-2 focus:ring-neutral-300 p-1.5 hover:bg-neutral-100 inline-flex items-center justify-center h-8 w-8 dark:text-neutral-500 dark:hover:text-neutral-50 dark:bg-neutral-900 dark:hover:bg-neutral-700">
