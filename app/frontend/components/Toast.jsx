...
export default function Toast({ message, type = 'success', duration = 5000 }) {
  useEffect(() => {
    ...
    toast.className = `fixed top-20 right-4 z-10 flex items-center w-full max-w-xs p-4 mb-4 text-neutral-500 bg-white rounded-lg shadow dark:text-neutral-400 dark:bg-neutral-900 animate-enter`
    toast.role = 'alert'
    ...
    const colors = {
      ...
      error: {
        icon: 'text-utility-500 bg-utility-100 dark:bg-utility-800 dark:text-utility-200',
